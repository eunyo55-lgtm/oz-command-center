...
export const mockCustomers: Customer[] = [
  { id: 'c001', customer_code: 'OZ-24-001847', name: '김지은', email: 'j***@naver.com', phone: '010-****-3821', signup_date: daysAgo(730), first_purchase_date: daysAgo(728), last_purchase_date: daysAgo(12), total_orders: 23, total_spent: 1840000, app_installed: true, rfm_segment: 'champions', lifecycle_stage: 'retained_d30', days_since_signup: 730, tags: ['VIP', '앱사용자', '리뷰어'] },
  { id: 'c002', customer_code: 'OZ-25-028341', name: '박서연', email: 's***@gmail.com', phone: '010-****-7102', signup_date: daysAgo(14), first_purchase_date: daysAgo(13), last_purchase_date: daysAgo(13), total_orders: 1, total_spent: 37200, app_installed: false, rfm_segment: 'new', lifecycle_stage: 'second_purchase_d14', days_since_signup: 14, tags: ['첫구매_완료', '앱미설치'] },
  { id: 'c003', customer_code: 'OZ-23-019402', name: '이민정', email: 'm***@daum.net', phone: '010-****-5518', signup_date: daysAgo(420), first_purchase_date: daysAgo(418), last_purchase_date: daysAgo(75), total_orders: 8, total_spent: 640000, app_installed: true, rfm_segment: 'at_risk', lifecycle_stage: 'dormant', days_since_signup: 420, tags: ['이탈위험', '앱사용자'] },
  { id: 'c004', customer_code: 'OZ-24-091203', name: '최유진', email: 'y***@naver.com', phone: '010-****-2947', signup_date: daysAgo(180), first_purchase_date: daysAgo(178), last_purchase_date: daysAgo(25), total_orders: 5, total_spent: 389000, app_installed: true, rfm_segment: 'loyal', lifecycle_stage: 'retained_d30', days_since_signup: 180, tags: ['앱사용자'] },
  { id: 'c005', customer_code: 'OZ-25-028402', name: '정하영', email: 'h***@gmail.com', phone: '010-****-6234', signup_date: daysAgo(7), first_purchase_date: daysAgo(5), last_purchase_date: daysAgo(5), total_orders: 1, total_spent: 52000, app_installed: true, rfm_segment: 'new', lifecycle_stage: 'engaged_d7', days_since_signup: 7, tags: ['첫구매_완료', '앱사용자'] },
  { id: 'c006', customer_code: 'OZ-24-045621', name: '한소영', email: 's***@kakao.com', phone: '010-****-8801', signup_date: daysAgo(90), first_purchase_date: daysAgo(88), last_purchase_date: daysAgo(45), total_orders: 3, total_spent: 178000, app_installed: false, rfm_segment: 'potential', lifecycle_stage: 'retained_d30', days_since_signup: 90, tags: ['앱미설치'] },
  { id: 'c007', customer_code: 'OZ-22-003847', name: '윤지민', email: 'j***@naver.com', phone: '010-****-4412', signup_date: daysAgo(1100), first_purchase_date: daysAgo(1098), last_purchase_date: daysAgo(3), total_orders: 41, total_spent: 3210000, app_installed: true, rfm_segment: 'champions', lifecycle_stage: 'retained_d30', days_since_signup: 1100, tags: ['VIP', '앱사용자', '리뷰어', '인플루언서'] },
  { id: 'c008', customer_code: 'OZ-25-028501', name: '강예린', email: 'y***@gmail.com', phone: '010-****-9934', signup_date: daysAgo(2), first_purchase_date: null, last_purchase_date: null, total_orders: 0, total_spent: 0, app_installed: false, rfm_segment: 'new', lifecycle_stage: 'browsing_d1', days_since_signup: 2, tags: ['미구매'] },
  { id: 'c009', customer_code: 'OZ-23-018203', name: '조미래', email: 'm***@daum.net', phone: '010-****-1023', signup_date: daysAgo(540), first_purchase_date: daysAgo(538), last_purchase_date: daysAgo(180), total_orders: 4, total_spent: 245000, app_installed: false, rfm_segment: 'hibernating', lifecycle_stage: 'dormant', days_since_signup: 540, tags: ['휴면'] },
  { id: 'c010', customer_code: 'OZ-24-076102', name: '임채원', email: 'c***@naver.com', phone: '010-****-5672', signup_date: daysAgo(60), first_purchase_date: daysAgo(58), last_purchase_date: daysAgo(8), total_orders: 3, total_spent: 156000, app_installed: true, rfm_segment: 'loyal', lifecycle_stage: 'retained_d30', days_since_signup: 60, tags: ['앱사용자'] },
];
